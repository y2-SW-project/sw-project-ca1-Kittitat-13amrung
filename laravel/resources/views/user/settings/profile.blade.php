                            ...
                            <div class="progress d-none">
                              ...
                              <div class="alert user-profile-img" role="alert">
                                ...
                                <label for="user-profile" class="label" data-toggle="tooltip" title="Change your profile image">
                                    @if (Auth::user()->image)
                                    <img class="rounded-2 img-fluid" src="{{ asset('/storage/profile/' . Auth::user()->image) }}" id="avatar" alt="avatar">
                                    @else
                                        <img class="rounded-2 img-fluid" id="avatar" alt="avatar" src="https://via.placeholder.com/280">
                                    @endif
                                </label>
