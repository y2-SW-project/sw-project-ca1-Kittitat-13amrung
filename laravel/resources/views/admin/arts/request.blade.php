...
@section('content')
    <main class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="text-end">
                    <a href="{{ route('arts.requests.create') }}" class="btn btn-dark rounded-pill p-3">
                        {{ __('Create A Request') }}
                    </a>
                </div>
            </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="my-5" id="request{{ $client->id }}">
                <div class="card border-bottom">
                    <h6 class="text-start card-subtitle">
                        @if ($client->commercial_use == "yes")   
                            <span class="text-white border-bottom border-end border-4 border-muted rounded-pill px-3 py-1 bg-tertiary">
                                Commercial Uses
                            </span>
                            @else
                            <span class="text-white border-bottom border-end border-4 border-muted rounded-pill px-3 py-1 bg-secondary">
                                Personal Uses
                            </span>
                            @endif
                        </h6>
                    ...
                    <a class="nav-link text-dark" href="{{ route('arts.requests.view', $client->id) }}">
                        ...
                        <h3 class="mb-5 text-capitalize card-title">
                            ...
                            <div class="h4 text-start card-text">
                                ...
                                Deadline: <span class="paragraph">
                                    {{ date('d-m-Y', strtotime($client->end_date)) }} (In {{ $client->days }} days)
                                </span>
                                <hr>
            ...
            <div class="col-lg-8 ms-3 rounded rounded-5  my-5 bg-secondary">
