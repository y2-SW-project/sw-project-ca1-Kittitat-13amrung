                        ...
                        <div data-id="{{ $car->id }}" class="col-3 my-2 mx-5">
                            <a href="{{ route('user.cars.show', $car->id) }}">
                                @if ($car->image_location)
                                    <img src="{{ asset('/storage/image/' . $car->image_location) }}"
                                        class="img-fluid my-2 mx-2" alt="{{ ' ' . $car->make . ' ' . $car->model }}">
                                @else
                                    <img src="{{ asset('/storage/image/img-preview.svg') }}" class="img-fluid my-2 mx-2"
